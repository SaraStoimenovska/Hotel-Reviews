...
describe('FavoritesComponent', () => {
  ...
  const hotelService = jasmine.createSpyObj('hotelService', ['getFavoriteHotels']);
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [FavoritesComponent, HotelComponent, DateTimePipe, DateFormatPipe],
      providers: [
  ...
  beforeEach(() => {
    ...
    getHotelsSpy = hotelService.getFavoriteHotels.and.returnValue(empty());
  ...
  it('should get all favorites hotels', () => {
    getHotelsSpy = hotelService.getFavoriteHotels.and.returnValue(of(favHotels));
  ...
  it('should show error on getting all favorites hotels', () => {
    getHotelsSpy = hotelService.getFavoriteHotels.and.returnValue(
